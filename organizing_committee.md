...
* **Nathalie Beaujean** – SBRI (Stem Cell and Brain Research Institute), INRAE
* **Hugo Blanc** – IGFL (Institut de Génomique Fonctionnelle de Lyon), ENS de Lyon
* **Mathilde Bouchet** – IGFL (Institut de Génomique Functional de Lyon), CNRS
* **Jonathan Enriquez** – IGFL (Institut de Génomique Fonctionnelle de Lyon), CNRS
* **Yad Ghavi-Helm** – IGFL (Institut de Génomique Fonctionnelle de Lyon), CNRS
